...
let records=activities.map(a=>({
  ...
  important:!!a.important, closeBufferMin:a.closeBufferMin ?? (a.important?45:15), planningNote:a.planningNote||'', hoursSource:a.hoursSource||{label:'Planning default',url:a.links?.[0]?.[1]||'',note:'Editable planning default.'},
